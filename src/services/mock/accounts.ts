...
export const DEMO_ACCOUNTS: readonly DemoAccount[] = [
  ...
  },
  {
    ...
    permissions: [SENSITIVE_PERMISSIONS.financialDetail, SENSITIVE_PERMISSIONS.exportProtected],
    primaryDivisionId: 'pia',
    scopedDivisionIds: ['pia', 'pit', 'gov', 'cjg', 'wcf'],
    scopedEmployeeIds: [],
    status: 'active',
    ...
    demonstrates: 'Finance WITH the financial-detail permission — cost fields visible',
  },
  {
    userId: 'usr-4002',
    employeeId: 'emp-4002',
    ...
    demonstrates: 'Finance WITHOUT the permission — hours only, cost fields restricted',
  },
  {
    userId: 'usr-5001',
    employeeId: 'emp-5001',
