...
const EMPTY_PROJECT: ProjectFormInput = {
  name: '', code: '', divisionId: 'pia', managerEmployeeId: 'emp-2001', memberIds: [], client: '',
...
function ProjectForm({ initial, onCancel, onSaved }: { initial?: TeamProjectView; onCancel: () => void; onSaved: (project: TeamProjectView) => void }) {
  ...
  const [form, setForm] = React.useState<ProjectFormInput>(() => initial ? {
    ...
    memberIds: [], client: initial.client ?? '', startDate: '2026-01-05', endDate: null,
  ...
  return (
    <form onSubmit={submit} className="space-y-5">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <Field label="Client"><Input value={form.client} onChange={(event) => set('client', event.target.value)} /></Field>
