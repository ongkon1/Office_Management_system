...
ON DUPLICATE KEY UPDATE name=VALUES(name),status=VALUES(status);
INSERT IGNORE INTO tasks(id,project_id,title,status,assignee_employee_id,estimated_minutes,due_date) VALUES
('81000000-0000-4000-8000-000000000001','80000000-0000-4000-8000-000000000001','Implement dashboard','in_progress','40000000-0000-4000-8000-000000000003',1200,'2026-09-15'),
('81000000-0000-4000-8000-000000000002','80000000-0000-4000-8000-000000000002','Secure reporting endpoint','pending','40000000-0000-4000-8000-000000000003',900,'2026-09-20'),
('81000000-0000-4000-8000-000000000003','80000000-0000-4000-8000-000000000003','Responsive content pages','pending','40000000-0000-4000-8000-000000000003',600,'2026-09-22');
